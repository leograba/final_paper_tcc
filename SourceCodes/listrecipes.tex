...
\begin{lstlisting}[frame=single, basicstyle=\linespread{0.85}\ttfamily, caption=Página gerenciadora de receitas da interface web, label=listrecipe_php]
<!DOCTYPE HTML>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body style="display:none;">
		...
		<section>
			...
			><div id="preview" style="display:none; width:50%; float:left; background:#595450; border-radius:10px;">
				...
				<p class="prevhead">Água de mosturação (l):</p><p class="prev" id="mosto"></p><br>
				<p class="prevhead">Água de lavagem (l):</p><p class="prev" id="lavagem"></p><br>
