\lstset{language=PHP}
\begin{lstlisting}[frame=single, basicstyle=\linespread{0.85}\ttfamily\tiny, caption=Módulo PHP que cria a barra de navegação da interface web, label=header_php]
<?php
