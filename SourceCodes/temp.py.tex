...
\begin{lstlisting}[frame=single, basicstyle=\linespread{0.85}\ttfamily\tiny, caption=Módulo com as funções para \textit{log} da temperatura, label=python_log_script]
#!/usr/bin/env python
# -*- coding: utf-8 -*-
