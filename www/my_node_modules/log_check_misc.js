...
var logToFile = module.exports.logToFile = function (message, code){
	var d = new Date();
	var dataToSave ;
	...
	global.environmentVariables.logTimestamp = d.getTime();//logs the request to start recipe timestamp
