...
<?php
  ...
  require './newrecipe.php';//file that does the magic, i.e. form handling, file saving, etc
...
<form class="myform" id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <input class="myform" type="button" value="Voltar" onClick="window.location='./listareceita.php'">
</form>
</body>
</html>
