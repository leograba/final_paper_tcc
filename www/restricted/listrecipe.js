function deleteRecipe(element){//if any del/undo button is clicked
	...
	$.post("./deleterecipe.php", {recipe:btnId, stat:whatToDo}, function(data, status){
...
function recipePreview(element){//when user put mouse into recipe name
	...
	$.post("./previewrecipe.php", {name:fileName}, function(data, status){//request recipe contents to server
		if(status == "success"){
