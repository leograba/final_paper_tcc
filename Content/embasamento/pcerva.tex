...
Em resumo, é apresentada na figura \ref{timeline} uma linha do tempo na qual estão listadas as partes essenciais do processo de produção de cerveja. Os momentos em que ocorrem cada uma destas partes são variáveis, dependendo de uma receita específica e, portanto, não foram especificados.

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{./Resources/time_diagram.png}
	\captionsetup{justification=centering}
	\caption[Linha do tempo de uma brassagem simples]{Linha do tempo de uma brassagem simples}
	\label{timeline}
\end{figure}
