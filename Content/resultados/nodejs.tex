...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.85]{./Resources/node_working.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{./Resources/BonescriptIO/high-10ms-9bits/Carga_processo.png}
	\captionsetup{justification=centering}
...
É importante salientar que testes no âmbito de segurança não foram conduzidos, embora este seja um tópico de grande interesse na área de internet das coisas (IoT). Nota-se também que nenhuma restrição de acesso à interface gráfica de usuário foi implementada neste projeto.
