...
\begin{table}[H]
	\centering
	\captionsetup{justification=centering}
	\caption[Consumo de recursos de memória e processamento em função do número de clientes conectados à BBB]{Consumo de recursos de memória e processamento em função do número de clientes conectados à BBB}
	\label{bench_server}
